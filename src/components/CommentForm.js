		...
		return (
			<form id="add-comment-form" className="comment-add-form">
				...
				<div className="form-group">
					<textarea id="add-comment-content" className="input-full"  name="body" placeholder="Comment Content"></textarea>
				</div>
				<div className="form-group">
					<input id="add-comment-author" type="text" name="author" placeholder="Author"/>
				</div>
